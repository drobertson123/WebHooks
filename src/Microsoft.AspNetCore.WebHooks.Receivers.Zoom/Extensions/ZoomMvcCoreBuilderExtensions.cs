...
{
    /// <summary>
    /// Extension methods for setting up Zoom WebHooks in an <see cref="IMvcCoreBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class ZoomMvcCoreBuilderExtensions
    {
        /// <summary>
        /// <para>
        ...
        public static IMvcCoreBuilder AddZoomWebHooks(this IMvcCoreBuilder builder)
        {
            if (builder == null)
            {
