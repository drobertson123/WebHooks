...
{
    /// <summary>
    /// An <see cref="IAsyncResourceFilter"/> that verifies the Zoom signature header. Confirms the header exists,
    ...
    public class VerifySignatureFilter : WebHookVerifySignatureFilter, IAsyncResourceFilter
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ZoomVerifySignatureFilter"/> instance.
        /// </summary>
        ...
        /// </param>
        public ZoomVerifySignatureFilter(
        ...
        /// <inheritdoc />
        public override string ReceiverName => ZoomConstants.ReceiverName;
