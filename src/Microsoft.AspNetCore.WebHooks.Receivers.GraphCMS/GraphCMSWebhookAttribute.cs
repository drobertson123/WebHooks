...
namespace Microsoft.AspNetCore.WebHooks
{
    /// <summary>
    /// <para>
    /// An <see cref="Attribute"/> indicating the associated action is a GraphCMS WebHook endpoint. Specifies the
    ...
    /// </para>
    /// <para>
    /// An example GraphCMS WebHook URI is '<c>https://{host}/api/webhooks/incoming/GraphCMS/{id}</c>'. See
    ...
    /// </para>
    /// <para>
    /// <see cref="GraphCMSWebhookAttribute"/> should be used at most once per <see cref="WebHookAttribute.Id"/> and
    /// <see cref="EventName"/> in a WebHook application.
    /// </para>
    /// </remarks>
    public class GraphCMSWebhookAttribute : WebHookAttribute, IWebHookEventSelectorMetadata
    {
        /// <summary>
        /// Instantiates a new <see cref="GraphCMSWebhookAttribute"/> indicating the associated action is a GraphCMS
        /// WebHook endpoint.
        /// </summary>
        public GraphCMSWebhookAttribute()
