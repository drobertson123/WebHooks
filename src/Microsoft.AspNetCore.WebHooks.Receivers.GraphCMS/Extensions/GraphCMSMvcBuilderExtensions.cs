...
{
    /// <summary>
    /// Extension methods for setting up GraphCMS WebHooks in an <see cref="IMvcBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class GraphCMSMvcBuilderExtensions
    {
        /// <summary>
        /// <para>
        ...
        public static IMvcBuilder AddGraphCMSWebHooks(this IMvcBuilder builder)
        {
            if (builder == null)
            {
