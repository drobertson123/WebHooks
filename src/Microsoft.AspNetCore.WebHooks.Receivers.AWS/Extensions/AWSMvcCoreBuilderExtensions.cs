...
{
    /// <summary>
    /// Extension methods for setting up AWS WebHooks in an <see cref="IMvcCoreBuilder" />.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class AWSMvcCoreBuilderExtensions
    {
        /// <summary>
        /// <para>
        ...
        public static IMvcCoreBuilder AddAWSWebHooks(this IMvcCoreBuilder builder)
        {
            if (builder == null)
            {
